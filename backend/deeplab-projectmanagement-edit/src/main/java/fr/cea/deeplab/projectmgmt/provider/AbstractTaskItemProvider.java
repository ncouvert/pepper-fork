...
/**
 * This is the item provider adapter for a {@link fr.cea.deeplab.projectmgmt.AbstractTask} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class AbstractTaskItemProvider extends ItemProviderAdapter
    ...
    protected void addNamePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_name_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_name_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_description_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_description_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__DESCRIPTION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addStartTimePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_startTime_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_startTime_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__START_TIME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addEndTimePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_endTime_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_endTime_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__END_TIME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addProgressPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_progress_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_progress_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__PROGRESS, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addComputeStartEndDynamicallyPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_computeStartEndDynamically_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__COMPUTE_START_END_DYNAMICALLY, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addTagsPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_tags_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_tags_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__TAGS, true, false, true, null, null, null));
    }
    ...
    protected void addAssignedPersonsPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_assignedPersons_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_assignedPersons_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__ASSIGNED_PERSONS, true, false, true, null, null, null));
    }
    ...
    protected void addAssignedTeamsPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AbstractTask_assignedTeams_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_assignedTeams_feature", "_UI_AbstractTask_type"),
                ProjectmgmtPackage.Literals.ABSTRACT_TASK__ASSIGNED_TEAMS, true, false, true, null, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ProjectmgmtPackage.Literals.ABSTRACT_TASK__SUB_TASKS);
        }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_AbstractTask_type") : this.getString("_UI_AbstractTask_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ProjectmgmtPackage.Literals.ABSTRACT_TASK__SUB_TASKS, ProjectmgmtFactory.eINSTANCE.createTask()));
    }
