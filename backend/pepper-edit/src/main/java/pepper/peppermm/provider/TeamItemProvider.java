...
public class TeamItemProvider extends ResourceItemProvider {
    ...
    protected void addMembersPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors
                .add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(), this.getString("_UI_Team_members_feature"),
                        this.getString("_UI_PropertyDescriptor_description", "_UI_Team_members_feature", "_UI_Team_type"), PepperPackage.Literals.TEAM__MEMBERS, true, false, true, null, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_Team_type") : this.getString("_UI_Team_type") + " " + label;
    }
