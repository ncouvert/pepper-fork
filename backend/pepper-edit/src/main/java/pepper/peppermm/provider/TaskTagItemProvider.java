...
public class TaskTagItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addPrefixPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_TaskTag_prefix_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_TaskTag_prefix_feature", "_UI_TaskTag_type"),
                PepperPackage.Literals.TASK_TAG__PREFIX, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addSuffixPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_TaskTag_suffix_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_TaskTag_suffix_feature", "_UI_TaskTag_type"),
                PepperPackage.Literals.TASK_TAG__SUFFIX, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
