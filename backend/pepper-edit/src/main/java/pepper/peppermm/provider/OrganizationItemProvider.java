...
public class OrganizationItemProvider extends ItemProviderAdapter
    ...
    protected void addNamePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_Organization_name_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_Organization_name_feature", "_UI_Organization_type"),
                PepperPackage.Literals.ORGANIZATION__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Organization.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_Organization_type") : this.getString("_UI_Organization_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(PepperPackage.Literals.ORGANIZATION__OWNED_PROJECTS, PepperFactory.eINSTANCE.createProject()));

        newChildDescriptors.add(this.createChildParameter(PepperPackage.Literals.ORGANIZATION__OWNED_RESOURCE_FOLDERS, PepperFactory.eINSTANCE.createResourceFolder()));
    }
